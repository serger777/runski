                ...
                if ($get_prew) { ?>
                    <div class="article-pagination__block pagination-prev-left">
                        ...
                        <div class="wrap-pagination-preview pagination-prev-left">
                            <div class="preview-article__img"><img src="<?php echo esc_url( get_the_post_thumbnail_url( $prev->ID ) ); ?>"
                ...
                <? if ($get_next) { ?>
                    ...
                    <div class="article-pagination__block pagination-prev-right"><a
                        ...
                        <div class="wrap-pagination-preview pagination-prev-right">
                            <div class="preview-article__img"><img src="<?php echo esc_url( get_the_post_thumbnail_url( $next->ID ) ); ?>"
                                                                   class="preview-article__image"></div>
                            <div class="preview-article__content">
                                <div class="preview-article__info"><a href="#"
